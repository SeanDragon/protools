...
//     * @throws Exception
//     */
//    public static byte[] threeDesEncrypt(byte[] src, byte[] keybyte) {
//        try {
//            // 生成密钥
...
//     * @throws Exception
//     */
//    public static byte[] threeDesDecrypt(byte[] src, byte[] keybyte) {
//        try {
//            // 生成密钥
//            byte[] key = new byte[24];
//            if (keybyte.length < key.length) {
...
//     * @throws Exception
//     */
//    public static String threeDesEncrypt(String src, String key) {
...
//     * @throws Exception
//     */
//    public static String threeDesDecrypt(String src, String key) {
